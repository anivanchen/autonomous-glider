...
void ICM_20948::debugPrintStatus(ICM_20948_Status_e stat)
{
  ...
  case ICM_20948_Stat_DMPNotSupported:
    std::cout << "DMP Firmware Not Supported. Is #define ICM_20948_USE_DMP commented in util/ICM_20948_C.h?" << std::endl;
    break;
...
ICM_20948_Status_e ICM_20948::checkID(void)
{
  ...
  {
    std::cout << "ICM_20948::checkID: ICM_20948_check_id returned: " << std::endl;
...
uint8_t ICM_20948::i2cMasterSingleR(uint8_t addr, uint8_t reg)
{
  ...
  if (status != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::i2cMasterSingleR: ICM_20948_i2c_master_single_r returned: " << std::endl;
    debugPrintStatus(status);
    std::cout << "" << std::endl;
  }
  return data;
...
ICM_20948_Status_e ICM_20948::startupDefault(bool minimal)
{
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: startupMagnetometer returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: setSampleMode returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: setFullScale returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: setDLPFcfg returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: enableDLPF (Acc) returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupDefault: enableDLPF (Gyr) returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
...
ICM_20948_Status_e ICM_20948::enableDMPSensorInt(enum inv_icm20948_sensor sensor, bool enable)
{
  if (_device._dmp_firmware_available == true) // Should we attempt to enable the sensor interrupt?
  {
    ...
    std::cout << "ICM_20948::enableDMPSensorInt:  _enabled_Android_intr_0: " << std::endl;
...
ICM_20948_Status_e ICM_20948_I2C::begin(uint8_t I2C_SDA, uint8_t I2C_SCL)
{
  // Initialize the I2C peripheral

  i2c_init(i2c0, 400000); // Initialize the I2C peripheral at 400kHz
  gpio_set_function(I2C_SDA, GPIO_FUNC_I2C); // Set the SDA pin to the I2C function
  gpio_set_function(I2C_SCL, GPIO_FUNC_I2C); // Set the SCL pin to the I2C function
  gpio_pull_up(I2C_SDA); // Pull up the SDA pin
...
ICM_20948_Status_e ICM_20948::startupMagnetometer(bool minimal)
{
  ...
  {
    std::cout << "ICM_20948::startupMagnetometer: reached MAX_MAGNETOMETER_STARTS (" << std::endl;
    std::cout << (int)MAX_MAGNETOMETER_STARTS << std::endl;
  ...
  {
    std::cout << "ICM_20948::startupMagnetometer: successful magWhoIAm after " << std::endl;
    std::cout << (int)tries << std::endl;
    if (tries == 1)
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupMagnetometer: writeMag returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::startupMagnetometer: i2cMasterConfigurePeripheral returned: " << std::endl;
    debugPrintStatus(retval);
    std::cout << "" << std::endl;
    status = retval;
    return status;
...
ICM_20948_Status_e ICM_20948::magWhoIAm(void)
{
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::magWhoIAm: whoiam1: " << std::endl;
    std::cout << (int)whoiam1 << std::endl;
    std::cout << " (should be 72) readMag set status to: " << std::endl;
    debugPrintStatus(status);
    std::cout << "" << std::endl;
    return retval;
  }
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    std::cout << "ICM_20948::magWhoIAm: whoiam1: " << std::endl;
    std::cout << (int)whoiam1 << std::endl;
    std::cout << " (should be 72) whoiam2: " << std::endl;
    std::cout << (int)whoiam2 << std::endl;
    std::cout << " (should be 9) readMag set status to: " << std::endl;
    debugPrintStatus(status);
    std::cout << "" << std::endl;
    return retval;
  }
